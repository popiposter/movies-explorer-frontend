      ...
      <section className="about-me__student">
        <div className="about-me__student-info">
          <article>
            ...
            <p className="about-me__student-subtitle">Фронтенд-разработчик, 30 лет</p>
            <p className="about-me__student-text">Я родился и живу в Саратове, закончил факультет экономики СГУ. У меня
              есть жена и дочь. Я люблю слушать
          ...
          <ul className="about-me__student-links">
            <li className="about-me__student-link-item">
              <a className="about-me__student-link" href="https://facebook.com" target="_blank"
                 rel="noreferrer">Facebook</a>
            </li>
            <li className="about-me__student-link-item">
              <a className="about-me__student-link" href="https://github.com" target="_blank"
                 rel="noreferrer">Github</a>
            </li>
          </ul>
        </div>
        <img className="about-me__student-pic" src={studentPath} alt="Фото студента."/>
      </section>
      <section className="about-me__portfolio">
        ...
        <ul className="about-me__portfolio-links">
          <li className="about-me__portfolio-links-item">
            <a className="about-me__portfolio-link" href="https://github.com" target="_blank" rel="noreferrer">
